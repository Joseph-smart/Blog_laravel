...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; <a href="#">系统基本信息</a> &raquo; 添加商品
    </div>
    <!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>PHP运行方式</label><span>v-1.0</span>
                </li>
                <li>
                    <label>CodingKing设计-版本</label><span>v-1.0</span>
                </li>
                <li>
